...
let id = document.querySelector('.dashboard .status-box .id');
...
let moduleBoxes = document.querySelectorAll('.dashboard .module-box');
let valueSlider = document.querySelector('.slider');
...
let sliderBlock = valueSlider.querySelector('.block');
let sliderTrack = valueSlider.querySelector('.track');
let silderTick = valueSlider.querySelector('.tick');
